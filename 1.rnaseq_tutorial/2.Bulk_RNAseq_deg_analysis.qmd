...
Here, we stick to 1 processor to not overload the server. If you're running this locally, you can omit the `processors` option and `kimma` will automatically run on all processors minus 2.
